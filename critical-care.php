...
<div class="col-lg-6">
  <h2 class="fw-bold mb-3">About Critical Care</h2>
  <p class="text-muted fs-5">
    Critical Care deals with the management of patients with life-threatening
    conditions requiring continuous monitoring, advanced life support and
    intensive medical interventions in a specialized ICU setup.
  </p>
  <ul class="tick mt-4">
    <li>24×7 Intensive Care Unit (ICU) services</li>
    <li>Advanced life support & ventilator care</li>
    <li>Multi-organ failure management</li>
    <li>Post-operative & trauma critical care</li>
  </ul>
</div>
...
<section class="py-5 bg-light">
  <div class="container">
    <h2 class="fw-bold text-start mb-4">Related Critical Care Services</h2>

    <div class="swiper related-services">
      <div class="swiper-wrapper">

        <div class="swiper-slide">
          <a href="medical-icu.php" class="related-box-unique">
        ...
        <div class="swiper-slide">
          <a href="surgical-icu.php" class="related-box-unique">
        ...
        <div class="swiper-slide">
          <a href="cardiac-icu.php" class="related-box-unique">
        ...
        <div class="swiper-slide">
          <a href="neuro-icu.php" class="related-box-unique">
        ...
        <div class="swiper-slide">
          <a href="trauma-care.php" class="related-box-unique">
            <div class="icon-circle-unique bg-info">
              <i class="bi bi-bandaid"></i>
            </div>
            <h6>Trauma & Emergency Care</h6>
          </a>
        </div>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="card-box-expert text-center">
            <div class="doc-img-wrapper">
              <img src="https://images.unsplash.com/photo-1612349317150-e413f6a5b16d" class="doc-img mb-3">
            </div>
            <h6>Dr. S. Kapoor</h6>
            <small class="text-muted">Critical Care Specialist</small>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card-box-expert text-center">
            ...
            <h6>Dr. R. Mehra</h6>
            <small class="text-muted">Intensivist</small>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card-box-expert text-center">
            ...
            <h6>Dr. A. Singh</h6>
            <small class="text-muted">ICU Consultant</small>
          </div>
        </div>
