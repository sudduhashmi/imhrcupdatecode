...
<div class="page-title-wave">
  <div class="container">
    <h2> Breast and Endocrine Surgery</h2>
  </div>
...
<div class="col-lg-6">
  <h2 class="fw-bold mb-3">About Breast & Endocrine Surgery</h2>
  <p class="text-muted fs-5">
    Breast and Endocrine Surgery focuses on the diagnosis and surgical treatment
    of breast conditions and disorders of endocrine glands including thyroid,
    parathyroid and adrenal glands, using safe and advanced surgical techniques.
  </p>
  <ul class="tick mt-4">
    <li>Breast lump evaluation & surgery</li>
    <li>Breast cancer surgery & reconstruction</li>
    <li>Thyroid, parathyroid & adrenal surgery</li>
    <li>Minimally invasive endocrine procedures</li>
  </ul>
</div>
...
<section class="py-5 bg-light">
  <div class="container">
    <h2 class="fw-bold text-start mb-4">Related Breast & Endocrine Services</h2>

    <div class="swiper related-services">
      <div class="swiper-wrapper">

        <div class="swiper-slide">
          <a href="breast-surgery.php" class="related-box-unique">
        ...
        <div class="swiper-slide">
          <a href="breast-cancer-surgery.php" class="related-box-unique">
            <div class="icon-circle-unique bg-danger">
              <i class="bi bi-ribbon"></i>
            </div>
            <h6>Breast Cancer Surgery</h6>
          </a>
        </div>

        <div class="swiper-slide">
          <a href="thyroid-surgery.php" class="related-box-unique">
            <div class="icon-circle-unique bg-success">
              <i class="bi bi-diagram-3"></i>
            </div>
            <h6>Thyroid Surgery</h6>
          </a>
        </div>

        <div class="swiper-slide">
          <a href="parathyroid-surgery.php" class="related-box-unique">
            <div class="icon-circle-unique bg-warning">
              <i class="bi bi-plus-circle"></i>
            </div>
            <h6>Parathyroid Surgery</h6>
          </a>
        </div>

        <div class="swiper-slide">
          <a href="adrenal-surgery.php" class="related-box-unique">
            <div class="icon-circle-unique bg-info">
              <i class="bi bi-capsule"></i>
            </div>
            <h6>Adrenal Surgery</h6>
          </a>
        </div>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="card-box-unique text-center">
            ...
            <h6 class="mt-2">Endocrinology</h6>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card-box-unique text-center">
            ...
            <h6 class="mt-2">Diagnostic Services</h6>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card-box-unique text-center">
            ...
            <h6 class="mt-2">Preventive Care</h6>
          </div>
        </div>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="card-box-expert text-center">
            ...
            <h6>Dr. N. Singh</h6>
            <small class="text-muted">Breast Surgeon</small>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card-box-expert text-center">
            ...
            <h6>Dr. P. Mehra</h6>
            <small class="text-muted">Endocrine Surgeon</small>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card-box-expert text-center">
            ...
            <h6>Dr. A. Kapoor</h6>
            <small class="text-muted">Oncosurgeon</small>
          </div>
        </div>
