...
/* CTA */
.cta{
    background: linear-gradient(135deg, #0d6efd, #1d274b);
...
<div class="col-lg-6">
  <h2 class="fw-bold mb-3">About Art Therapy</h2>
  <p class="">
    Art Therapy is a therapeutic approach that uses creative art activities to
    help individuals express emotions, improve communication, enhance cognitive
    skills and promote emotional well-being.
  </p>
  <ul class="tick mt-4">
    <li>Emotional expression & stress reduction</li>
    <li>Behavioural and emotional regulation</li>
    <li>Social interaction and confidence building</li>
    <li>Creative skill development & self-awareness</li>
  </ul>
</div>
...
<section class="py-5 bg-light">
  <div class="container">
    <h2 class="fw-bold text-start mb-4">Related Therapies</h2>
    ...
    <div class="swiper related-services">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <a href="aba-therapy.php" class="related-box-unique">
            <div class="icon-circle-unique bg-success">
              <i class="bi bi-diagram-3"></i>
            </div>
            <h6>Applied Behaviour Analysis (ABA)</h6>
          </a>
        </div>

        <div class="swiper-slide">
          <a href="speech-therapy.php" class="related-box-unique">
            <div class="icon-circle-unique bg-danger">
              <i class="bi bi-chat-dots"></i>
            </div>
            <h6>Speech Therapy</h6>
          </a>
        </div>

        <div class="swiper-slide">
          <a href="occupational-therapy.php" class="related-box-unique">
            <div class="icon-circle-unique bg-warning">
              <i class="bi bi-hand-index-thumb"></i>
            </div>
            <h6>Occupational Therapy</h6>
          </a>
        </div>

        <div class="swiper-slide">
          <a href="sensory-integration.php" class="related-box-unique">
            <div class="icon-circle-unique bg-info">
              <i class="bi bi-puzzle"></i>
            </div>
            <h6>Sensory Integration Therapy</h6>
          </a>
        </div>
...
<section class="py-5">
  <div class="container">
     <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <a href="all-therapies.php" class="btn btn-outline-primary btn-sm">All Services</a>
    </div>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="card-box-unique text-center">
            ...
            <h6 class="mt-2">Parent Empowerment</h6>
          </div>
        </div>

        <div class="swiper-slide">
          <div class="card-box-unique text-center">
            <i class="bi bi-ear fs-1 text-success"></i>
            <h6 class="mt-2">Language & Communication</h6>
          </div>
        </div>

        <div class="swiper-slide">
          <div class="card-box-unique text-center">
            <i class="bi bi-person-arms-up fs-1 text-warning"></i>
            <h6 class="mt-2">Physiotherapy</h6>
          </div>
        </div>

        <div class="swiper-slide">
          <div class="card-box-unique text-center">
            <i class="bi bi-universal-access fs-1 text-info"></i>
            <h6 class="mt-2">Assistive Devices</h6>
          </div>
        </div>

        <div class="swiper-slide">
          <div class="card-box-unique text-center">
            <i class="bi bi-compass fs-1 text-danger"></i>
            <h6 class="mt-2">Orientation & Mobility</h6>
          </div>
        </div>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="card-box-expert text-center">
            <div class="doc-img-wrapper">
              <img src="https://images.unsplash.com/photo-1559839734-2b71ea197ec2" class="doc-img mb-3">
            </div>
            <h6>Ms. A. Khan</h6>
            <small class="text-muted">Certified Art Therapist</small>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card-box-expert text-center">
            ...
            <h6>Mr. R. Verma</h6>
            <small class="text-muted">Behaviour Therapist</small>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card-box-expert text-center">
            ...
            <h6>Dr. P. Mehta</h6>
            <small class="text-muted">Occupational Therapist</small>
          </div>
        </div>
