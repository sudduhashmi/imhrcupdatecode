<?php
$pageTitle = 'Profile | Imhrc';
$bodyClass = '';
require_once __DIR__ . '/includes/head.php';
?>
<!-- Additional CSS for Profile -->
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
							<div class="pd-20 card-box height-100-p">
								<div class="profile-photo">
									...
									></a>
									<?php $profileAvatarUrl = $avatarUrl ?? ('https://ui-avatars.com/api/?background=4c6fff&color=fff&name=' . urlencode($_SESSION['admin_name'] ?? $_SESSION['student_name'] ?? 'User')); ?>
									<img
										src="<?php echo $profileAvatarUrl; ?>"
										alt=""
										class="avatar-photo"
									/>
									<div
