...
<div class="page-title-wave">
  <div class="container">
    <h2> Adult CTVS (Cardiothoracic and Vascular Surgery)</h2>
  </div>
...
<div class="col-lg-6">
  <h2 class="fw-bold mb-3">About Adult CTVS</h2>
  <p class="text-muted fs-5">
    Adult Cardiothoracic and Vascular Surgery (CTVS) focuses on surgical
    treatment of heart, lungs and major blood vessels using advanced techniques.
  </p>
  <ul class="tick mt-4">
    <li>Coronary artery bypass surgery</li>
    <li>Heart valve repair & replacement</li>
    <li>Aortic & vascular surgery</li>
...
<section class="py-5 bg-light">
  <div class="container">
    <h2 class="fw-bold text-start mb-4">Related CTVS Services</h2>

    <div class="swiper related-services">
      <div class="swiper-wrapper">

        <div class="swiper-slide">
          <a href="coronary-bypass-surgery.php" class="related-box-unique">
            <div class="icon-circle-unique bg-primary">
              <i class="bi bi-heart-pulse"></i>
            </div>
            <h6>Coronary Bypass Surgery</h6>
          </a>
        </div>

        <div class="swiper-slide">
          <a href="valve-replacement.php" class="related-box-unique">
            <div class="icon-circle-unique bg-danger">
              <i class="bi bi-heart"></i>
            </div>
            <h6>Valve Replacement Surgery</h6>
          </a>
        </div>

        <div class="swiper-slide">
          <a href="aortic-aneurysm.php" class="related-box-unique">
            <div class="icon-circle-unique bg-success">
              <i class="bi bi-diagram-3"></i>
            </div>
            <h6>Aortic Aneurysm Surgery</h6>
          </a>
        </div>
...
<section class="py-5">
  <div class="container">
     <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <a href="clinical-&-diagnostic-services.php" class="btn btn-outline-primary btn-sm">All Services</a>
    </div>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="card-box-expert text-center">
            ...
            <h6>Dr. R. Sharma</h6>
            <small class="text-muted">Senior CTVS Surgeon</small>
          </div>
        </div>
