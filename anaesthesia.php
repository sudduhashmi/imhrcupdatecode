...
<div class="col-lg-6">
  <h2 class="fw-bold mb-3">About Anaesthesia</h2>
  <p class="text-muted fs-5">
    Anaesthesia is a specialized medical service focused on pain management,
    sedation and patient safety before, during and after surgical and diagnostic
    procedures.
  </p>
  <ul class="tick mt-4">
    <li>General, regional and local anaesthesia</li>
    <li>Pre-operative assessment & risk evaluation</li>
    <li>Intra-operative monitoring & safety</li>
...
<div class="col-lg-6">
  <img src="assets/img/images.jpg"
       class="img-fluid rounded-4 shadow" style="    width: 100%;">
</div>
...
<section class="py-5 bg-light">
  <div class="container">
    <h2 class="fw-bold text-start mb-4">Related Anaesthesia Services</h2>

    <div class="swiper related-services">
      <div class="swiper-wrapper">

        <div class="swiper-slide">
          <a href="general-anaesthesia.php" class="related-box-unique">
            <div class="icon-circle-unique bg-primary">
              <i class="bi bi-hospital"></i>
            </div>
            <h6>General Anaesthesia</h6>
          </a>
        </div>

        <div class="swiper-slide">
          <a href="regional-anaesthesia.php" class="related-box-unique">
            <div class="icon-circle-unique bg-success">
              <i class="bi bi-bandaid"></i>
            </div>
            <h6>Regional Anaesthesia</h6>
          </a>
        </div>

        <div class="swiper-slide">
          <a href="local-anaesthesia.php" class="related-box-unique">
            <div class="icon-circle-unique bg-warning">
              <i class="bi bi-plus-circle"></i>
            </div>
            <h6>Local Anaesthesia</h6>
          </a>
        </div>

        <div class="swiper-slide">
          <a href="sedation.php" class="related-box-unique">
            <div class="icon-circle-unique bg-info">
              <i class="bi bi-moon"></i>
            </div>
            <h6>Sedation Services</h6>
          </a>
        </div>

        <div class="swiper-slide">
          <a href="pain-management.php" class="related-box-unique">
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="card-box-unique text-center">
            ...
            <h6 class="mt-2">Critical Care</h6>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card-box-unique text-center">
            ...
            <h6 class="mt-2">Emergency Medicine</h6>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card-box-unique text-center">
            ...
            <h6 class="mt-2">Surgical Services</h6>
          </div>
        </div>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="card-box-expert text-center">
            ...
            <h6>Dr. S. Mishra</h6>
            <small class="text-muted">Senior Anaesthesiologist</small>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card-box-expert text-center">
            ...
            <h6>Dr. R. Gupta</h6>
            <small class="text-muted">Consultant Anaesthetist</small>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card-box-expert text-center">
            ...
            <h6>Dr. A. Verma</h6>
            <small class="text-muted">Pain Management Specialist</small>
          </div>
        </div>
