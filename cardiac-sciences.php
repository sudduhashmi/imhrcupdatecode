...
<div class="col-lg-6">
  <h2 class="fw-bold mb-3">About Cardiac Sciences</h2>
  <p class="text-muted fs-5">
    Cardiac Sciences is a comprehensive specialty focused on the diagnosis,
    treatment and management of heart and vascular diseases through advanced
    medical, interventional and surgical care.
  </p>
  <ul class="tick mt-4">
    <li>Non-invasive & invasive cardiology</li>
    <li>Interventional cardiology & cath lab procedures</li>
    <li>Cardiac surgery & minimally invasive techniques</li>
    <li>Cardiac rehabilitation & preventive cardiology</li>
  </ul>
</div>
...
<section class="py-5 bg-light">
  <div class="container">
    <h2 class="fw-bold text-start mb-4">Related Cardiac Services</h2>

    <div class="swiper related-services">
      <div class="swiper-wrapper">

        <div class="swiper-slide">
          <a href="cardiology.php" class="related-box-unique">
        ...
        <div class="swiper-slide">
          <a href="interventional-cardiology.php" class="related-box-unique">
            <div class="icon-circle-unique bg-primary">
              <i class="bi bi-activity"></i>
            </div>
            <h6>Interventional Cardiology</h6>
          </a>
        </div>

        <div class="swiper-slide">
          <a href="cardiac-surgery.php" class="related-box-unique">
        ...
        <div class="swiper-slide">
          <a href="electrophysiology.php" class="related-box-unique">
        ...
        <div class="swiper-slide">
          <a href="heart-failure-clinic.php" class="related-box-unique">
            <div class="icon-circle-unique bg-info">
              <i class="bi bi-heart"></i>
            </div>
            <h6>Heart Failure Clinic</h6>
          </a>
        </div>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="card-box-unique text-center">
            ...
            <h6 class="mt-2">Emergency Cardiac Care</h6>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card-box-unique text-center">
            ...
            <h6 class="mt-2">Cardiac Diagnostics</h6>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card-box-unique text-center">
            ...
            <h6 class="mt-2">Preventive Cardiology</h6>
          </div>
        </div>

        <div class="swiper-slide">
          <div class="card-box-unique text-center">
            <i class="bi bi-person-heart fs-1 text-info"></i>
            <h6 class="mt-2">Cardiac Rehabilitation</h6>
          </div>
        </div>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="card-box-expert text-center">
            ...
            <h6>Dr. A. Khanna</h6>
            <small class="text-muted">Senior Cardiologist</small>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card-box-expert text-center">
            ...
            <h6>Dr. S. Verma</h6>
            <small class="text-muted">Cardiac Surgeon</small>
          </div>
        </div>
